module Api
  module Underwriting
    class ReferralsController < ApplicationController
      ...
      def index
        render json: UnderwritingReferral.order(created_at: :desc).as_json(include: { submission: { include: %i[business risk] }, quote: {} })
      end

      def show
        render json: referral.as_json(include: { submission: { include: %i[business risk] }, quote: { include: :quote_options } })
      end
